...
public class JUnitTesting extends TestCase
{
	...
	public void testCrearVuelo()
	{
		...
		gc.CrearVuelos(BasesDeDatos.getStatement(), "234244", "34", "2016/13/23", "442324", "6543354");
		...
		gc.CrearVuelos(BasesDeDatos.getStatement(), "45656", "15", "2014/01/15", "89779", "879789");
	...
	public void testDevolverVuelos() 
	{
		...
		gc.CrearVuelos(BasesDeDatos.getStatement(), codigo, "34", "2016/01/30", "453453", "87686");
